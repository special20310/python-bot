...
BOT_TOKEN = "6071261576:AAFT6Vg8mo904AdfKefdq32Pmc0jt416lVc"
PAYMENT_CHANNEL = "@dkwakaak" #add payment channel here including the '@' sign
OWNER_ID = 6358212605 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@dkwakaak"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
